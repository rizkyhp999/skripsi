...
export function ModalEdit({
  closeModal,
  selectedCarouselId,
  selectedCarouselGambar,
  selectedCarouselJudul,
  selectedCarouselDeskripsi,
}: data) {
  const [isLoading, setIsLoading] = useState(false);
            ...
            <div className="mb-4">
              ...
              <label htmlFor="gambar" className="cursor-pointer">
                <Image
                  src={
                    previewImages[0] ??
                    selectedCarouselGambar ?? // Use the nullish coalescing operator here
                    "/komponen/addGambar.png"
                  }
                  alt={`Preview`}
                  width={300}
                  height={300}
