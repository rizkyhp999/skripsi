...
export default function page() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 ">
      <div className="container relative flex flex-col lg:flex-row w-full max-w-4xl p-6 bg-white rounded-lg shadow-md">
        ...
        <div className="relative w-full lg:w-1/2 h-64 lg:h-auto lg:rounded-l-lg overflow-hidden hidden lg:block ">
          <Image
